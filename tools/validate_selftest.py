...
def mutations():
    ...
    return [
        ...
        ('regulation misquoted (4.2)', TARGET,
         lambda d: d[0]['grounding'].append({'kind': 'statute', 'statute': 'sebi-aif-2012',
             'clause': 'reg-3', 'version': 'April 18, 2026', 'source': 'SEBI', 'locator': 'reg 3',
             'quote': 'Category II funds may borrow without limit'})),
        ('regulation quoted from a stale version (13.4)', TARGET,
         lambda d: d[0]['grounding'].append({'kind': 'statute', 'statute': 'sebi-aif-2012',
             'clause': 'reg-3', 'version': 'September 09, 2025', 'source': 'SEBI', 'locator': 'reg 3',
             'quote': 'which employs diverse or complex trading strategies'})),
